...
For these two reasons, this approach was abandoned in favor of the [current HTML attribute proposal](#alternative-an-html-content-attribute-old-version).
