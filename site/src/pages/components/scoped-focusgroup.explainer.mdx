...
Focusgroup directional navigation is only triggered when an arrow key is pressed without modifier keys. When any of Ctrl, Alt, Meta, or Shift is held, the user agent does not perform focusgroup navigation, allowing modifier+arrow combinations to retain their platform-specific behaviors (such as word-by-word text navigation with Ctrl+Arrow, or text selection with Shift+Arrow).

This rule, along with the rationale per behavior token, is captured normatively in the [WHATWG focusgroup pull request](https://github.com/whatwg/html/pull/11723) — see the [modifier-key handling additions](https://github.com/whatwg/html/pull/11723/changes/1017afbf2920147b4658a986d71813936e431a57) for the specification text. Default modifier expectations for individual behavior tokens (e.g., `radiogroup`, `listbox`) are tracked in [Open UI issue #1418](https://github.com/openui/open-ui/pull/1418).
...
- [Modifier keys suppress focusgroup directional navigation, preserving platform behaviors such as Ctrl+Arrow and Shift+Arrow](https://github.com/whatwg/html/pull/11723/changes/1017afbf2920147b4658a986d71813936e431a57)
