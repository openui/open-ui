...
- Authors should take care to ensure that content between focusgroup items is limited to avoid a user "missing" content as they navigate through the focusgroup.
