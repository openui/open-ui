...
While having additional new high level abstractions to handle keyboard navigation (such as
[focusgroup](/components/scoped-focusgroup.explainer)) will be useful, there is a multitude of different
