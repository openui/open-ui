...
Some of these occur when showing interest in links, and some when showing interest in buttons. Notes around the screenshots indicate whether/how these features can be accessed with the keyboard or touchscreen.

<img src='/images/interesttarget-use-cases.png' width="800" alt='Survey of production web use cases for interesttarget' />
