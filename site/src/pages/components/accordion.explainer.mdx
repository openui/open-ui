...
The [spicy-sections repository](https://github.com/tabvengers/spicy-sections)
(also see [proposal to transfer](https://github.com/openui/open-ui/issues/517))
also has significant work that shares a bit of history with panelset.
(**TODO**: Do they share enough history that this section
should be combined with the previous?)

Like panelset, it is making a single proposal
