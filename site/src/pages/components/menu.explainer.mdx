...
* Events:
    ...
    * A `checked` event is fired on checkable menu items that have their state changed. This happens
      ...
      [Issue #1321](https://github.com/openui/open-ui/issues/1321). Note that this happens before
      any popovers that need to be closed as a result of activation, are dismissed.
* Checkability:
