...
A basic polyfill has been written, which implements the behaviors described by this explainer.

The polyfill is available at Github:

- https://github.com/keithamus/invokers-polyfill
- https://www.npmjs.com/package/invokers-polyfill
