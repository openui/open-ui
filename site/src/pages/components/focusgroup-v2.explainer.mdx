...
<p class="question">How much grid topology can user agents infer safely from HTML structure, and where should authors provide explicit signals? Inference should reduce authoring overhead without making topology ambiguous or fragile when markup includes generic elements, wrappers, row groups, mixed structures, or dynamic changes, and without using authored ARIA roles as behavior configuration.</p>
