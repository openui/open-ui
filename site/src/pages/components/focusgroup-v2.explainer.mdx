...
The focusgroup proposal was originally developed by [Travis Leithead](https://github.com/travisleithead), [David Zearing](https://github.com/dzearing), and [Chris Holt](https://github.com/chrisdholt), then [moved to Open UI](https://github.com/openui/open-ui/pull/516) for continued incubation. [Jacques Newman](https://github.com/janewman) later [revived it with a scoped design](https://github.com/openui/open-ui/pull/1260) and has led its continued development, including V2. Thanks to everyone whose issues, reviews, and discussions have shaped the proposal.
