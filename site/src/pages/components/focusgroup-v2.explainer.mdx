...
The focusgroup proposal was originally developed by [Travis Leithead](https://github.com/travisleithead), [David Zearing](https://github.com/dzearing), and [Chris Holt](https://github.com/chrisdholt), then [moved to Open UI](https://github.com/openui/open-ui/pull/516) for continued incubation. After the proposal [became inactive](https://github.com/openui/open-ui/pull/1195), [Jacques Newman](https://github.com/janewman) [revived it with a scoped design](https://github.com/openui/open-ui/pull/1260) and has led its subsequent development, including V2. Thanks to everyone whose issues, reviews, and discussions have continued to shape the proposal.
