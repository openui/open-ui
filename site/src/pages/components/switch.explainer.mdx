...
- `drag&drop`: the switch can be toggled by dragging the thumb (optional, in addition to `click`/`touch`)
-
...
<div class="question">
  If form associated, should default value of "on" be submitted if the switch is on and the user did
  not specify a value to align with the [checkbox default value
...
| ------------- | -------------- | --------- | ------------- | ----------------------------------------------------------------------------------------- |
| `checked`     | `checked`      | `boolean` | `false`       | Indicates if the switch should be "on" initially.                                         |
