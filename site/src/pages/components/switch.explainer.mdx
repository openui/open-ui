...
### Input type checkbox with switch attribute
...
<div style="max-width: 400px; margin-inline: auto">
  ![Internal components of a toggle
  switch](https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Light_switch_inside_explained.jpg/440px-Light_switch_inside_explained.jpg)
</div>
...
<div style="max-width: 400px; margin-inline: auto">
  ![Switch example by Material Design, Google
  Inc.](https://lh3.googleusercontent.com/9ZiRb_i7vCmW5HZ_uu-WNFljJQUnVSMY9ZOnku7ZknH0t9J0AkZwU7NcowggDruiZ6_bwUru_B1QxLq87L6a5NLVlJns4-8aSvq8aYUCFh28=s0)
</div>
...
- Drag & drop: toggles the switch in the direction of the movement, the thumb follows the pointer
- Swipe: toggles the switch in the direction of the swiping movement, the thumb follows the touch interaction
- Focus & space: toggles the switch
...
<div class="question">Feedback on this feature would be welcome.</div>
