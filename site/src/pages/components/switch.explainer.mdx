...
Design Systems that recommend immediate action:

1. [Ant Design (uses button)](https://ant.design/components/switch#when-to-use)
2. [Material Design 3](https://m3.material.io/components/switch/guidelines#b8773628-a5cb-4883-991f-4da6879baeff)(uses [buttons](https://github.com/material-components/material-web/blob/main/switch/internal/switch.ts))
3. [Evergreen (uses checkbox)](https://evergreen.segment.com/components/switch)
4. [Fast (uses div)](https://github.com/microsoft/fast/blob/master/packages/web-components/fast-foundation/src/switch/switch.spec.md#documentation)
5. [Atlaskit (uses checkbox)](https://atlassian.design/components/toggle/usage#best-practices)
6. [Carbon (uses button)](https://carbondesignsystem.com/components/toggle/usage#overview)
7. [Fluent UI (uses button)](https://developer.microsoft.com/en-us/fluentui#/controls/web/toggle)
8. [Lion (uses div)](https://lion-web.netlify.app/components/switch/overview/#when-to-use)
9. [Primer (uses button)](https://primer.style/design/components/toggle-switch)

Design Systems that encourage non-immediate action:
_No Data found for explicit encouragement, allthough implementations that rely on a checkbox indirectly allow that behavior._

Design Systems that don't make any statement about recommended usage:

- [Bootstrap (uses checkbox)](https://getbootstrap.com/docs/5.3/forms/checks-radios/#switches)
- [Lightning (uses checkbox)](https://www.lightningdesignsystem.com/components/checkbox-toggle/)
- [KoliBri (uses checkbox)](https://public-ui.github.io/docs/components/input-checkbox)
- [Semantic UI (uses checkbox)](https://semantic-ui.com/modules/checkbox.html)
- [Spectrum (uses checkbox)](https://spectrum.adobe.com/page/switch/)
- [Tailwind Elements (uses checkbox)](https://tailwind-elements.com/docs/standard/forms/switch/)
- [WAI-ARIA (examples include button and checkbox variant)](https://www.w3.org/WAI/ARIA/apg/patterns/switch/)
...
<div class="question">
  <div>
    ...
    Should both variants be supported by toggling an attribute or is one or the other obsolete? Can a base markup be provided that enables devs to do one or the other variant with custom styles?
...
<switch>
  ...
  <button part="button">
    <span part="track">
      <span part="active-track-side">
        <slot name="active-track"></slot>
      </span>
      <span part="inactive-track-side">
        <slot name="inactive-track"></slot>
      </span>
    </span>
    <span part="thumb">
...
The control can be in a checked or unchecked state. Exposure of states will be defined by AT. [^6]
