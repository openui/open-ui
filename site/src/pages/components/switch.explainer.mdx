...
<p class="question">
  Should the "switch" be used to trigger immediate actions only? A majority of Design Systems
  recommend this behavior. This decision can have influence on the API in regards to form
...
1. [Ant Design](https://ant.design/components/switch#when-to-use)
2. [Material Design 3](https://m3.material.io/components/switch/guidelines#b8773628-a5cb-4883-991f-4da6879baeff)
3. [Evergreen](https://evergreen.segment.com/components/switch)
4. [Fast](https://github.com/microsoft/fast/blob/master/packages/web-components/fast-foundation/src/switch/switch.spec.md#documentation)
5. [Atlaskit](https://atlassian.design/components/toggle/usage#best-practices)
6. [Carbon](https://carbondesignsystem.com/components/toggle/usage#overview)
7. [Fluent UI](https://developer.microsoft.com/en-us/fluentui#/controls/web/toggle)
8. [Microsoft Desktop](https://learn.microsoft.com/en-us/windows/apps/design/controls/toggles#choosing-between-toggle-switch-and-check-box)
9. [Lion](https://lion-web.netlify.app/components/switch/overview/#when-to-use)
10. [Primer](https://primer.style/design/components/toggle-switch)
...
- [Lightning](https://www.lightningdesignsystem.com/components/checkbox-toggle/)
- [KoliBri](https://public-ui.github.io/docs/components/input-checkbox)
- [Semantic UI](https://semantic-ui.com/modules/checkbox.html)
- [Spectrum](https://spectrum.adobe.com/page/switch/)
- [Tailwind Elements](https://tailwind-elements.com/docs/standard/forms/switch/)
