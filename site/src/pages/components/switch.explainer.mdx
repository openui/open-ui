...
<div class="question">
  The ARIA specification recommends updating the `aria-checked` attribute when toggling the switch.
  Is this necessary or can this be handled similar to how checkboxes work?
</div>
