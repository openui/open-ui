...
> **Note:** These names follow the `::slider-*` convention from [css-forms-1](https://drafts.csswg.org/css-forms-1/), which treats switches as slider-like controls. Naming is subject to change as the spec evolves.
...
|---|---|---|
| WebKit/Safari | **Positive** (shipped) | Shipped unflagged since Safari 17.4. Pseudo-elements (`::slider-thumb`, `::slider-track`) are behind a flag. |
