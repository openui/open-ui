...
A champion has slightly more responsibility than a contributor. A champion is responsible for moving a proposal from one stage to the next, attending meetings, gathering input, synthesizing it, and advancing it through the [stages](/working-mode). In order to become a champion you need to:
