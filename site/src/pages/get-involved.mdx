...
We have a weekly telecon on Thursdays at 11AM - 12PM PST. We post the agenda will be posted by Tuesday EOD on the Discord telecon channel along with the Jitsi video telecon link. The agenda and minute archives can be found [here](https://github.com/openui/open-ui/tree/main/meetings/telecon).
