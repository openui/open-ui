...
/src
  /components
    your-component.mdx           # proposal page
...
The `research` key tells your proposal page where its research page is hosted.
...
Define your research page front matter.
The `researchFor` key tells your research page where its proposal page is hosted.
