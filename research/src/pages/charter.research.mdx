...
- Converging designer processes and developer workflows

# Scope of work

- Utilize descriptivism of common patterns to identify and standardize on:
  - Standardize component names and parts
  - Standardize on states
  - Standardize on inputs that transition states (eg: keyboard or pointer interaction)
- Cover for each component the necessary accessibilty requirements (this is not in place of
  WIA-ARIA or WICAG but linking where appropriate to alleviate implementor pain)
- Upon discovery of gaps in the web platform, denote those and raise relevant issues

# Out of scope

- Standardization of default appearance of the component
...
- Merge of the review sign off will be done by the editors of Open UI. Current editors are:
  - Greg Whitworth
  - Levi Thomason
...
The initial chairs were chosen based on the group being spun up by Levi Thomason and Greg
Whitworth. Upon the need or desire for adding/changing co-chairs the process will be as such:
...
- There should be no more than 3 co-chairs at any one time
