...
* Solves the [Accessibility/Semantics problem](new.popup.explainer.alternatives.md#alternative-dedicated-popup-element).
 ...
 * [Other Alternatives Considered](new.popup.explainer.alternatives.md)
