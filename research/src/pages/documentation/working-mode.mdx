...
| 4   | Finished        | Indicate that the component is implemented.               | Component has an stable implementation or specification.                                            | You can use the web component in production.                          | N/A                                                                                                                                                                                                                                |
