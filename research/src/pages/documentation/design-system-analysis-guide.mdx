...
Utilize the [Component Spec Template](https://github.com/openui/open-ui/blob/master/research/src/pages/component-spec-template.mdx)
...
Copy the content from the [Component Spec Template](https://github.com/openui/open-ui/blob/master/research/src/pages/component-spec-template.mdx)
...
After this front matter, copy in the content from the [Component Research Template](https://github.com/openui/open-ui/blob/master/research/src/pages/component-research-template.mdx).
