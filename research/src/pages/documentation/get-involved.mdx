...
[Discord server](https://discord.gg/DEWjhSw) - Where we hold general discussions between our meetings
[Open UI Github](https://github.com/WICG/open-ui) - Where we house the website's repo and open issues
[Open UI Telecon Agendas](https://github.com/WICG/open-ui/tree/master/meetings/telecon) - Where you can find the minutes of our previous meetings, as well as the agendas for upcoming ones
[Open UI community group](https://www.w3.org/community/open-ui/)

If you'd like to be added to the meeting invites, you can reach out to Greg or Una from within Discord.
...
1. Look at all the design systems you can get find and see how they treat your Component.
...
- Create Component Spec: component-spec-template.mdx which will involves specifying the anatomy, behavior and states of a component. Things you should consider in your Component spec:
...
For new elements, you’ll also need to add a new document that adheres to the conformance requirements (for validators/conformance checkers) to ARIA in HTML: https://w3c.github.io/html-aria/
