...
## &lt;select&gt; Attributes <a href="#attributes" id="attributes"></a>
...
## &lt;select&gt; Methods <a href="#methods" id="methods"></a>
...
- `<button>` - The button element that contains the selected value and triggers the visibility of the popup **[required]**
...
### Content not allowed within anatomy
