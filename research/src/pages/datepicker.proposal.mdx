...
| `firstDayOfWeek`     | `firstDayOfWeek`                                                                            | `enum<DaysOfWeek>`                                                         | `DaysOfWeek.Moday`                | Which day should be the first column in the `calendar`                                           |
| `format`             | `format`                                                                                    | `string`                                                                   | inherited from locale settings    | Date format to be used in the `input`. _Consider having a callback instead_                      |
