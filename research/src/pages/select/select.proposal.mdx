...
| -------------- | :-----------------------------------------------: | ------------------------------------------------------------------: |
| `click`        |        Toggles the open state on the host         |                                           [open state](#open-state) |
| `click`        |               Toggles aria-expanded               | [aria-expanded](#https://www.w3.org/TR/wai-aria-1.1/#aria-expanded) |
| `keyup(space)` | Toggles the [open state](#open-state) on the host |                                           [open state](#open-state) |
| `keyup(space)` |               Toggles aria-expanded               | [aria-expanded](#https://www.w3.org/TR/wai-aria-1.1/#aria-expanded) |
| `keyup(enter)` | Toggles the [open state](#open-state) on the host |                                           [open state](#open-state) |
| `keyup(enter)` |               Toggles aria-expanded               | [aria-expanded](#https://www.w3.org/TR/wai-aria-1.1/#aria-expanded) |
