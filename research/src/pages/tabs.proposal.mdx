...
*Tabs* are a component which provides [well-defined meaning and interaction](https://www.w3.org/TR/wai-aria-practices/#tabpanel) allowing one-at-a-time, non-sequential viewing over a series of thematically grouped, state independent and labelled sections. They merely increase the users ability to understand and consume these bits of content.
