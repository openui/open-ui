...
Keybaord interactions are defined only for data grid type of Table component and can be used only after user has moved focus to the grid using `Tab` key.
